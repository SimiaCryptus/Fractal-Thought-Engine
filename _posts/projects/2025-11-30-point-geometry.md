...
featured_image: /assets/images/2025-11-30-point-geometry/main.png
og_image: >-
  /assets/images/2025-11-30-point-geometry/semantic_vs_mesh_reconstruction_png.png
...
## 1. Abstract
 ...
 ![**Figure 1:** Contrast between standard surface reconstruction (fitting a skin) versus semantic reconstruction (discovering the underlying geometric blueprint).](/assets/images/2025-11-30-point-geometry/semantic_vs_mesh_reconstruction_png.png)
...
### 2.1. The Data Flow
![**Figure 2:** The system architecture. Unlike traditional autoencoders, the latent bottleneck is an explicit, interpretable geometric graph.](/assets/images/2025-11-30-point-geometry/geometric_autoencoder_architecture_png.png)
...
![**Figure 3:** Visualizing the library of differentiable geometric constraints used to define the "Theory."](/assets/images/2025-11-30-point-geometry/constraint_library_visualization_png.png)
...
![**Figure 4:** The Bilevel Optimization Strategy. The "Architect" (GA) modifies the graph structure, while the "Engineer" (Solver) optimizes the spatial coordinates for that structure.](/assets/images/2025-11-30-point-geometry/bilevel_optimization_cycle_png.png)
