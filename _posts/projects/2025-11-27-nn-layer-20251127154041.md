...
featured_image: /assets/images/2025-11-27-nn-layer-20251127154041/main.png
og_image: >-
  /assets/images/2025-11-27-nn-layer-20251127154041/interpolated_density_entropy_forward_pass_pipeline.png
meta_title: >-
...
![Forward pass pipeline of the InterpolatedDensityEntropy layer: sorting, distance computation, density construction, normalization, and entropy calculation.](/assets/images/2025-11-27-nn-layer-20251127154041/interpolated_density_entropy_forward_pass_pipeline.png)
...
\text{Entropy: } & H = -\int_{s_1}^{s_n} p(x) \log p(x) \, dx
 \end{align}$$
![Construction of piecewise linear density function: clustered input values produce higher density peaks, while spread values yield lower density regions.](/assets/images/2025-11-27-nn-layer-20251127154041/piecewise_linear_density_construction.png)
![Weight computation for density estimation: boundary points use single-sided distance, while interior points average contributions from both neighboring distances.](/assets/images/2025-11-27-nn-layer-20251127154041/weight_computation_boundary_cases.png)
...
![Differential entropy as the integral of -p(x)log p(x): the orange curve shows the entropy contribution at each point, with total entropy equal to the shaded area.](/assets/images/2025-11-27-nn-layer-20251127154041/entropy_integral_visualization.png)
...
![Entropy output range: from negative infinity for degenerate concentrated distributions to log(range) for uniform distributions, with typical values between -5 and 10.](/assets/images/2025-11-27-nn-layer-20251127154041/entropy_range_spectrum.png)
