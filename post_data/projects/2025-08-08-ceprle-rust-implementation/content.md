...
![CEP-RLE project architecture showing the modular organization of core encoding, analysis, and utility components with their interdependencies.](cep_rle_project_architecture_diagram.png)
...
![CEP-RLE dependency ecosystem showing categorized Rust crates for numerical computing, spatial indexing, serialization, image processing, and performance optimization.](cep_rle_dependency_ecosystem.png)
...
![Visual representation of the ContinuousRun structure showing sub-pixel precision boundaries and associated geometric, spatial, and temporal metadata properties.](continuous_run_data_structure.png)
...
![Visualization of spatial relationships between continuous runs, showing horizontal neighbors within scanlines and vertical neighbors across scanlines with coherence scoring.](spatial_relationships_network.png)
