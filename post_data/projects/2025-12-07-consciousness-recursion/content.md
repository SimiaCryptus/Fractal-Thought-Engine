...
![**Figure 1.1: The Self-Writing Text.** A visual representation of the ontological paradox where the observer (reader) and the creator (writer) are topologically identical within a closed causal loop.](recursive_hand_writing_paradox.png)
...
![**Figure 2.1: The Collapse of Thought.** Visualizing how conscious attention acts as a measurement operator, forcing a nebulous superposition of potential ideas into a single, concrete reality.](thought_superposition_collapse_diagram.png)
...
![**Figure 2.2: Retroactive State Selection.** The mechanism by which observation at $t_2$ imposes boundary conditions that select the specific history at $t_1$ required to generate the present moment.](retrocausal_selection_timeline.png)
...
![**Figure 2.3: The Consciousness Recursion Loop.** Your observation at t₂ reaches backward to influence thought-generation at t₁, which produces the content that causes observation at t₂. The loop is self-sustaining and has no external origin point.](deja_vu_temporal_echo_art.png)
...
![**Figure 3.2: Linear vs. Recursive Prediction.** Contrasting the standard model of predictive processing with the recursive model, where the brain receives data from its own future light cone.](predictive_loop_architecture.png)
