...
## Technical Design
![Cross-sectional view of the tungsten penetrator assembly showing the subcritical core geometry, neutron initiation source, and directed thermal venting channels.](tungsten_penetrator_core_schematic.png)
...
![Operational sequence: 1. Approach, 2. Kinetic Penetration, 3. Vector Orientation, 4. Neutron Initiation and Thermal Thrust Generation.](impact_penetration_sequence_diagram.png)
...
![Comparative orbital mechanics for Planetary Defense (deflection) versus Mining Operations (../../assets/images/2025-08-08-nuclear-asteroid-propulsion/orbital capture and insertion).](orbital_deflection_mining_trajectories.png)
...
![Concept visualization of the automated Lunar L2 assembly facility, where nuclear components are integrated prior to deep-space deployment.](lunar_l2_assembly_platform.png)
...
![Simulation of thermal energy transfer from the tungsten jacket to the surrounding asteroid matrix, creating directed propulsive mass ejection.](thermal_venting_physics_simulation.png)